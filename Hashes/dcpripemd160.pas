...
class function THashRipeMD160.HashSize: integer;
begin
  Result:= 160;
end;

class function THashRipeMD160.Algorithm: THashAlgorithm;
begin
  Result:= haRipeMD160;
end;

class function THashRipeMD160.SelfTest: boolean;
const
...
procedure THashRipeMD160.Update(const Buffer; Size: longword);
var
  PBuf: ^byte;
begin
...
procedure THashRipeMD160.Final(var Digest);
begin
  if not fInitialized then
    raise EHash.Create('Hash not initialized');
  HashBuffer[Index]:= $80;
